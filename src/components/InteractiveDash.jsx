...
export default function DashboardPreview() {
  return (
    <div className="w-full py-18 bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900/20 dark:to-emerald-900/20 rounded-xl shadow-inner border border-dashed border-teal-300 dark:border-teal-800 p-6 flex flex-col justify-between text-teal-600 dark:text-teal-300">
      ...
      {/* Charts */}
      <div className="grid grid-cols-2 gap-4 items-stretch h-full px-2">
        {/* Bar Chart */}
        <div className="min-h-[250px] h-full bg-white/80 dark:bg-slate-800/60 backdrop-blur-lg p-4 rounded-xl border border-teal-200 dark:border-teal-700 shadow flex flex-col">
          <h4 className="text-sm font-semibold mb-2 text-gray-800 dark:text-white">
            Monthly Risk Detections
          </h4>
        ...
        {/* Donut Chart */}
        <div className="min-h-[250px] h-full bg-white/80 dark:bg-slate-800/60 backdrop-blur-lg p-3 rounded-xl border border-teal-200 dark:border-teal-700 shadow flex flex-col items-center justify-center">
          <h4 className="text-sm font-semibold mb-2 text-gray-800 dark:text-white">
            Retention Rate
          </h4>
          <ResponsiveContainer width="100%" height={180}>
